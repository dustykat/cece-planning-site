...
# 
# Contributed by Kayleigh Millerick
# 
# ---
...
# - Overview (1 page)  
#  
# - Background (~33% of Paper):  This can be set up as: 
...
#  
# - Overview of Proposed Microbial Solution (~10%):  Broadly, how are you going to address “the gap” that you identified in the paragraph above? 
...
#  
# - Approach (40-60% of Paper):  What is the scientific rationale behind why you think the proposed microbial solution will work, and how would you recommend implementing this technology? 
...
#  
# - Potential Impacts of Proposed Work (10-15%; ~ 1 page):  This is an expansion of 
...
# Example dates below are typical for a Fall Semester.
# - Email outlining your topic in 2 – 3 sentences or an email asking for help in selecting a topic no later than November 5th.  
# <!--I can help you focus your topic and/or identify sources. --> 
